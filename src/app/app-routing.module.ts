	...
	},
	{
		...
		children: [
			...
			},
			{
				path: 'dashboard-view',
				loadChildren: () =>
					import('./modules/dashboard/dashboard-view/dashboard-view.module').then(
			...
			},
			{
				path: 'information',
				loadChildren: () =>
					import('./modules/dashboard/information/information.module').then((m) => m.InformationModule)
			},
			{
				path: 'quotes',
			...
			},
			{
				...
				loadChildren: () =>
					import('./modules/dashboard/request-management/request-management.module').then(
